  ...
  return (
    <div className="rounded-xl border border-border bg-bg p-6 font-mono">
      <div className="flex items-center gap-3 border-b border-border pb-4 mb-6">
        ...
        <span className="text-xs text-text-dim">Career.EventStore.replay() — {careerEvents.length} events</span>
      </div>
      <div className="space-y-2">
        <p className="text-xs text-text-dim mb-4">{"// click a role to expand project details"}</p>
