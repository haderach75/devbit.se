...
export function ExperienceItem({ title, company, dates, description }: ExperienceItemProps) {
  return (
    <div className="mb-4">
      <p className="font-semibold text-base text-text-body">{title}</p>
      <p className="text-base text-crimson">{company}</p>
      <p className="font-mono text-sm text-text-dim">{dates}</p>
