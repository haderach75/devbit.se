...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: {
      en: "Architecture reviews, tech strategy, and mentoring for development teams.",
      sv: "Arkitekturgranskningar, teknisk strategi och mentorskap för utvecklingsteam.",
    },
    icon: "MessageSquare",
  },
];
